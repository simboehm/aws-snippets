...
# Loop through the reservations and instances to print the instance ID and AMI ID
...
# Loop through all instances in the EC2 resource and print their name and type
